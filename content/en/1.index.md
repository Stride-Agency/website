...
::bento-grid{grid-classes="lg:grid-cols-12 auto-rows-auto"}
  :::bento-card
  ---
  ...
  description: We don’t just develop—we engineer platforms that drive action.
    Using behavioral psychology, we design experiences that turn visitors into
  ...
  description: Forget back-and-forth emails that slow everything down. Get
    updates, ask questions, and make decisions instantly—directly in Slack.
  ...
  ---
  card-classes: lg:col-span-7 lg:row-span-1
  description: We don’t take on dozens of clients at once. We keep our workload
    lean so every project gets the attention, care, and precision it deserves.
